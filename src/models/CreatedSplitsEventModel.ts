...
export default class CreatedSplitsEventModel
  extends Model<
    InferAttributes<CreatedSplitsEventModel>,
    InferCreationAttributes<CreatedSplitsEventModel>
  >
